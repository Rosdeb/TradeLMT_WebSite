      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-white/70 leading-relaxed">
          ...
          <section>
            ...
            <p>Your account data is retained for as long as your account is active. You may request deletion at any time by contacting us at <a href="mailto:support@tradelmt.com" className="text-green-400">support@tradelmt.com</a>.</p>
          </section>
          ...
          <section>
            ...
            <p>For any privacy-related questions, contact us at <a href="mailto:support@tradelmt.com" className="text-green-400">support@tradelmt.com</a>.</p>
          </section>
        </div>
      </div>
    </div>
